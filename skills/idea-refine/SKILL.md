...
Ask the user if they'd like to save this to `.ideas/[idea-name].md` (or a location of their choosing). Create the `.ideas/` directory if it doesn't exist. Only save if they confirm.
