...
The last task in every plan should be a browser smoke test using `agent-browser`. This runs after all code changes are complete and all specs pass.
...
**Do NOT report the implementation as complete until browser verification passes.**
